                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href='blabla'><i className="fa fa-skype"></i> Skype</a>
                        ...
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    id="telnum" name="telnum" placeholder="Telephone Number" 
                                    validators={{
                                        required, 
                                        minLength: minLength(3),
                                        maxLength: maxLength(15),
                            ...
                            <Row className="form-group">
                                <Col md={{size: 6, offset: 2}}>
                                    <div className="form-check">
                                        <Label check>
                                            <Control.checkbox name="agree" model=".checkbox" className="form-check-input"/>
